...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Здравствуйте! Что бы заказать пиццу или спагетти введите: /food",
...
# Функция, которая доступна только администратору,
...
def register_handlers_common(dp: Dispatcher, admin_id: int):
    ...
    dp.register_message_handler(secret_command, IDFilter(user_id=admin_id), commands="Ого! Да вы же Администратор!")
